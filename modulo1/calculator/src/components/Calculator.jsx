    ...
    <div>
      ...
      <Container maxWidth="xs">
        <div className="wrapper">
          ...
          <button className="btnFontOrange" onClick={clear}>C</button>
          <button onClick={changeSign}>+/-</button>
          <button onClick={porcentage}>%</button>
          <button className="green" onClick={operatorHandler} value="/">
            /
          </button>
          ...
          <button className="green" onClick={operatorHandler} value="X">
            X
          </button>
          ...
          <button className="btnGreen" onClick={calculate}>
            =
          </button>
        </div>
      </Container>
